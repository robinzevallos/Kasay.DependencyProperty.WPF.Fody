[![NuGet Status](http://img.shields.io/nuget/v/Kasay.DependencyProperty.WPF.Fody.svg?style=flat&max-age=86400)](https://www.nuget.org/packages/Kasay.DependencyProperty.WPF.Fody/)
